...
var headerNavElement = document.querySelector('.header__navigation');
var headerElement = document.querySelector('.header__container');
var headerToggleElement = document.querySelector('.header__navigation-toggle');
var linkElements = document.querySelectorAll('.header__navigation-link');
...
var closeOnOutBoundaries = function closeOnOutBoundaries() {
  document.addEventListener('click', function (evt) {
    var withinBoundaries = evt.composedPath().includes(headerNavElement);
    if (!withinBoundaries) {
      closeMenu();
    }
  });
